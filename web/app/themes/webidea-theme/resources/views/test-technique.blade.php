...
@section('head')
<link rel="preload" as="image" imagesrcset="@asset('images/hero-bg-1x.jpg') 1x, @asset('images/hero-bg-2x.jpg') 2x">
@endsection
...
<section class="section-hero">
    <img fetchpriority="high" class="hero-bg" src="@asset('images/hero-bg-2x.jpg')" alt="hero bg" width="1920"
        ...
        <div class="container">
            <div class="section-services__service">
                <div class="section-services__content">
                    <span split class="surtitle section-services__surtitle">Nisi nec velit</span>
                    <h2 split class="section-services__title">Nullam pulvinar felis at metus malesuada</h2>
                    <p split class="section-services__text">Pellentesque tincidunt tristique neque, eget venenatis enim
                    ...
                    <div fade-up class="btn-link section-services__button">Découvrez le service</div>
                </div>
        ...
        <div class="container">
            <div class="section-services__service-2">
                <div class="section-services__content section-services__content-3">
                    <span split class="surtitle section-services__surtitle">Bibendum curabitur magna</span>
                    <h2 split class="section-services__title">Aenean sed nibh a magna posuere</h2>
                    <p split class="section-services__text">Maecenas interdum lorem eleifend orci aliquam mollis aliquam
                        non
                        rhoncus magna :</p>
                    <ul split class="section-services__list">
                ...
                <div class="section-services__content section-services__content-4">
                    ...
                    <img fade-up class="section-services__pc" src="@asset('images/pc-2x.png')" alt="bg-image"
                        loading="lazy" width="599" height="507"
                        srcset="@asset('images/pc-1x.png') 1x, @asset('images/pc-2x.png') 2x">
                </div>
            </div>
        </div>
    </div>
...
<section class="section-slider">
        ...
        <div class="container">
            <div class="section-slider__wrapper">
                <div class="content section-slider__content">
                    <span split class="surtitle surtitle section-slider__surtitle">Massa metus proin</span>
                    <h2 split class="title section-slider__title">Dolor imperdiet</h2>
                    <p split class="text section-slider__text">Phasellus risus turpis, pretium sit amet magna non,
                        molestie
                        ultricies enim.
    ...
    <div class="row">
        <div class="container">
            ...
            <div class="section-slider__navigation-mobile">
                <div class="section-slider__prev-btn-mobile">
                    <img src="@asset('images/arrow.svg')" alt="logo" width="24" height="24" loading="lazy">
                </div>
                <div class="section-slider__next-btn-mobile">
                    <img src="@asset('images/arrow.svg')" alt="logo" width="24" height="24" loading="lazy">
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="section-form__wrapper">
                <div class="content section-form__content">
                    <span split class="surtitle section-form__surtitle">Sodales aliquam</span>
                    <h2 split class="title section-form__title">Odio mauris diam</h2>
                    <p split class="text section-form__text">Phasellus risus turpis, pretium sit amet magna non,
                        molestie
                        ultricies enim. Nullam pulvinar felis at metus malesuada.</p>
                </div>
                <div class="section-form__form">
                    <div fade-up class="section-form__form-wrapper">
                    ...
                    <div class="section-form__form-wrapper-full">
                        <div fade-up class="textarea-form">
                            <label for="message">Message</label>
                            <textarea name="message" cols="30" rows="10"></textarea>
                        </div>

                        <div fade-up class="checkbox-form">
                            <label for="check">
                        ...
                        <div fade-up class="btn-primary section-form__submit">Envoyer</div>
                    </div>
                </div>
            </div>
        </div>
